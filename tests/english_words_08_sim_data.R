...
english_words_08 <- data_simulation(probvec_Z = probvec_Z,
                           probvec_V = probvec_V,
                           probvec_Q = probvec_Q,
                           probvec_F = probvec_F,
                           P0=P0,
...
time_stamps <- english_words_08$Tvec
log_events <- english_words_08$Yvec
...
Nvec <- english_words_08$Nvec

#add dataset to the RJSMC package
usethis::use_data(english_words_08,RJSMC,overwrite = T)
